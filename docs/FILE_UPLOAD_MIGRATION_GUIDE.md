...
Multipart удалён из всех entity-эндпоинтов. Все эндпоинты принимают только JSON.
...
Multipart-загрузка **удалена** из всех entity-эндпоинтов. Файлы загружаются только через `POST /upload/files`.
