...
func (s *Service) AddPosition(ctx context.Context, name string, description *string) (int64, error) {
	return s.repo.AddPosition(ctx, name, description)
}
...
func (s *Service) EditPosition(ctx context.Context, id int64, name *string, description *string) error {
	return s.repo.EditPosition(ctx, id, name, description)
}
