...
type VacancyByIDGetter interface {
	GetVacancyByID(ctx context.Context, id int64) (*recruiting.Vacancy, error)
}

func GetVacancy(log *slog.Logger, svc VacancyByIDGetter) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		const op = "handlers.hrm.recruiting.GetVacancy"
		...
		vacancy, err := svc.GetVacancyByID(r.Context(), id)
		if err != nil {
