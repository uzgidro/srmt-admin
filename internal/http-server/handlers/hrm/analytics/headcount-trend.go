...
type HeadcountTrendGetter interface {
	GetHeadcountTrend(ctx context.Context, filter dto.ReportFilter) (*analytics.HeadcountTrend, error)
}

func GetHeadcountTrend(log *slog.Logger, svc HeadcountTrendGetter) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		result, err := svc.GetHeadcountTrend(r.Context(), filter)
		if err != nil {
