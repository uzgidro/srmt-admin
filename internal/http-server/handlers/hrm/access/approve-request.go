...
type AccessRequestApprover interface {
	ApproveRequest(ctx context.Context, id int64, approvedBy int64) error
}

func ApproveRequest(log *slog.Logger, svc AccessRequestApprover) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		const op = "handlers.hrm.access.ApproveRequest"
		...
		if err := svc.ApproveRequest(r.Context(), id, claims.ContactID); err != nil {
